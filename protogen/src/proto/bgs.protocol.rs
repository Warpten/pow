...
/// Nested message and enum types in `FieldRestriction`.
...
/// Nested message and enum types in `RepeatedFieldRestriction`.
...
/// Nested message and enum types in `EntityIdRestriction`.
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct SdkFieldOptions {
    #[prost(bool, optional, tag = "4")]
    pub deprecated_32_bit: ::core::option::Option<bool>,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
pub enum ClientRegisterMethodType {
    RegisterClientNone = 0,
    RegisterClientRegistered = 1,
    RegisterClientUnregistered = 2,
    RegisterClientUnregisteredNotification = 3,
}
impl ClientRegisterMethodType {
    /// String value of the enum field names used in the ProtoBuf definition.
    ///
    /// The values are not transformed in any way and thus are considered stable
    /// (if the ProtoBuf definition does not change) and safe for programmatic use.
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::RegisterClientNone => "REGISTER_CLIENT_NONE",
            Self::RegisterClientRegistered => "REGISTER_CLIENT_REGISTERED",
            Self::RegisterClientUnregistered => "REGISTER_CLIENT_UNREGISTERED",
            Self::RegisterClientUnregisteredNotification => {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "REGISTER_CLIENT_NONE" => Some(Self::RegisterClientNone),
            "REGISTER_CLIENT_REGISTERED" => Some(Self::RegisterClientRegistered),
            "REGISTER_CLIENT_UNREGISTERED" => Some(Self::RegisterClientUnregistered),
            "REGISTER_CLIENT_UNREGISTERED_NOTIFICATION" => {
                Some(Self::RegisterClientUnregisteredNotification)
            }
            _ => None,
        }
    }
...
pub struct BgsMethodOptions {
    ...
    pub custom_region_resolver: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(bool, optional, tag = "9")]
    pub explicit_region_routing: ::core::option::Option<bool>,
    #[prost(bool, optional, tag = "10")]
    pub obsolete: ::core::option::Option<bool>,
    #[prost(enumeration = "ClientRegisterMethodType", optional, tag = "11")]
    pub client_register_type: ::core::option::Option<i32>,
    #[prost(string, optional, tag = "12")]
    pub forward_key_proto_file: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "13")]
    pub forward_shard_name: ::core::option::Option<::prost::alloc::string::String>,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Nested message and enum types in `BGSServiceOptions`.
    ...
    impl ServiceType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::RpcDirect => "SERVICE_TYPE_RPC_DIRECT",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "SERVICE_TYPE_RPC_DIRECT" => Some(Self::RpcDirect),
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct TitleIconContentHandle {
    #[prost(uint32, optional, tag = "1")]
    pub title_id: ::core::option::Option<u32>,
    #[prost(message, optional, tag = "2")]
    pub content_handle: ::core::option::Option<ContentHandle>,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Nested message and enum types in `AttributeFilter`.
