...
pub struct AccountLevelInfo {
    ...
    pub birthdate: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(bool, optional, tag = "21")]
    pub legal_country_feature_restrictions_applied: ::core::option::Option<bool>,
    #[prost(message, optional, tag = "22")]
    pub opt_ins: ::core::option::Option<OptIns>,
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Nested message and enum types in `PrivacyInfo`.
...
pub struct ParentalControlInfo {
    ...
    #[prost(bool, optional, tag = "11")]
    pub in_game_purchase_disabled: ::core::option::Option<bool>,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct GameSessionInfo {
    ...
    #[prost(bool, optional, tag = "11")]
    pub igr_paid: ::core::option::Option<bool>,
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Nested message and enum types in `IgrId`.
pub mod igr_id {
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct AccountPrivacySetting {
    #[prost(bool, optional, tag = "1")]
    pub is_using_rid: ::core::option::Option<bool>,
    #[prost(bool, optional, tag = "2")]
    pub is_visible_for_view_friends: ::core::option::Option<bool>,
...
pub struct AccountInfo {
    ...
    pub country: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "7")]
    pub default_currency: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(uint32, optional, tag = "8")]
    pub preferred_region: ::core::option::Option<u32>,
    #[prost(uint32, optional, tag = "9")]
    pub ratings_board_minimum_age: ::core::option::Option<u32>,
    #[prost(bool, optional, tag = "10")]
    pub has_parental_control: ::core::option::Option<bool>,
    #[prost(bool, optional, tag = "11")]
    pub is_email_verified: ::core::option::Option<bool>,
    #[prost(bool, optional, tag = "12")]
    pub is_sms_protected: ::core::option::Option<bool>,
    #[prost(bool, optional, tag = "13")]
    pub is_headless_account: ::core::option::Option<bool>,
    #[prost(bool, optional, tag = "14")]
    pub is_employee: ::core::option::Option<bool>,
    #[prost(bool, optional, tag = "15")]
    pub is_test_account: ::core::option::Option<bool>,
    #[prost(message, optional, tag = "16")]
    pub privacy_setting: ::core::option::Option<AccountPrivacySetting>,
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct RestrictionStatus {
    ...
    #[prost(uint64, optional, tag = "2")]
    pub expiration_us: ::core::option::Option<u64>,
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct AccountPlatformRestrictionInfo {
    #[prost(message, optional, tag = "2")]
    pub squelched: ::core::option::Option<RestrictionStatus>,
    #[prost(message, optional, tag = "3")]
    pub legal_country_feature_restrictions_applied: ::core::option::Option<
        RestrictionStatus,
    >,
}
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetAccountPlatformRestrictionsRequest {
    #[prost(message, optional, tag = "1")]
    pub account_id: ::core::option::Option<super::super::EntityId>,
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetAccountPlatformRestrictionsResponse {
    #[prost(message, optional, tag = "1")]
    pub restriction_info: ::core::option::Option<AccountPlatformRestrictionInfo>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
